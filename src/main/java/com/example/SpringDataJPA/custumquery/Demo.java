package com.example.SpringDataJPA.custumquery;
...
import com.example.SpringDataJPA.custumquery.util.InputUtil;
            ...
            do {
                ...
                switch (menuOption) {
                    ...
                    default:
                        ...
                        break;
                    case 5:
                        String lastName=InputUtil.acceptOwnerLastToOperate(scanner);
                        List<OwnerDTO> ownerDTOS=ownerService.findByLastName(lastName);
                        System.out.println(String.format("Found owner with petId %s.",lastName));
                        ownerDTOS.forEach(System.out::println);
                }
