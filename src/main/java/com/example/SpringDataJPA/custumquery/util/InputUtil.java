...
public class InputUtil {
    ...
    public static int acceptMenuOption(Scanner scanner) {
        ...
        System.out.println("Press 5 to fetch owner details by Last name.");
    ...
    public static String acceptOwnerLastToOperate(Scanner scanner) {
        System.out.println("Enter initials of Last name of owner:");
        return scanner.next();
    }
}